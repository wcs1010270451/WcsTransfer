...
export default function PortalKeysPage() {
  ...
  const columns = [
    ...
    { title: "脱敏密钥", dataIndex: "masked_key", key: "masked_key", width: 200 },
    {
      title: "状态",
      dataIndex: "status",
      key: "status",
      width: 80,
      render: (v) => <Tag color={v === "active" ? "blue" : "default"}>{v === "active" ? "启用" : "停用"}</Tag>,
    },
    {
      title: "累计消费",
      key: "total_cost",
    ...
    },
    {
      ...
      key: "expires_at",
      width: 120,
      render: (v) => (v ? new Date(v).toLocaleString("zh-CN") : "永不过期"),
    },
    {
      title: "操作",
      key: "actions",
